...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/argos-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12705&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/argos-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `argos` can be installed with:

```
conda install argos
```

It is possible to list all of the versions of `argos` available on your platform with:
